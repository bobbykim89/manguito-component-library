...
<template>
  <Story title="Base Component" group="design-system">
    ...
    <Variant title="tooltip">
      <div
        class="min-h-[100vh] grid grid-cols-3 gap-6 justify-items-center content-center mb-2xs bg-white py-sm px-xs md:py-md md:px-sm"
      >
        <div class="col-span-3">
          <h3>Tooltips directions</h3>
        </div>
        <div class="place-self-center">
          <button v-tooltip text="Default tooltip" class="btn">Default</button>
        </div>
        <div class="place-self-center">
          <button v-tooltip.right text="Tooltip text" class="btn btn-secondary">
            Right
          </button>
        </div>
        <div class="place-self-center">
          <button v-tooltip.left text="Tooltip text" class="btn btn-success">
            Left
          </button>
        </div>
        <div class="place-self-center">
          <button v-tooltip.top text="Tooltip text" class="btn btn-info">
            Top
          </button>
        </div>
        <div class="place-self-center">
          <button v-tooltip.bottom text="Tooltip text" class="btn btn-warning">
            Bottom
          </button>
        </div>
        <div class="col-span-3">
        ...
        <div class="place-self-center">
          <button v-tooltip text="Tooltip text" color="primary" class="btn">
            Primary
          </button>
        </div>
        <div class="place-self-center">
        ...
        <div class="place-self-center">
          <button v-tooltip text="Tooltip text" class="btn">Default</button>
        </div>

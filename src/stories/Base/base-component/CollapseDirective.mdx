...
# Collapse Directive (Internal)

> **Note**: This directive is primarily used internally by Collapsible and Accordion components. It works in conjunction with the `observeVisibleAttr` composable for reactive state management.
...
import { vCollapse, observeVisibleAttr } from '@bobbykim/manguito-theme'

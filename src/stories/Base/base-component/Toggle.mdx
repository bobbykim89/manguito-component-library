...
# Toggle Directive & Observe Visible Attribute (Internal)

> **Note**: This directive and composable are primarily used internally by Modal and Sidebar components. They work together to provide reactive visibility control.

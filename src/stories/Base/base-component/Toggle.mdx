...
# Toggle Directive (Internal)

> **Note**: This directive is primarily used internally by Modal and Sidebar components. It works in conjunction with the `observeVisibleAttr` composable to provide reactive visibility control.

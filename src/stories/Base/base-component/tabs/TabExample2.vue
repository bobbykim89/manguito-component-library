      ...
      <template #tab-button="{ update, activeTab }">
        <div class="flex justify-start gap-[2px] md:flex-col">
          <button
            ...
            class="rounded-tl-md bg-light-4 px-xs py-2xs font-bold transition-all duration-300 hover:bg-opacity-70 md:rounded-t-md"
            @click="update(0)"
          >
            Tab 0
          </button>
          ...
          <button
            ...
            class="rounded-tr-md bg-light-4 px-xs py-2xs font-bold transition-all duration-300 hover:bg-opacity-70 md:rounded-tr-none md:rounded-b-md"
            @click="update(3)"
          >
            Tab 3
          </button>
